...
/**
 * lugares/page.tsx
 * Página del módulo de lugares turísticos con estructura idéntica al dashboard principal.
...
import {
  MapPin, Database, Moon, Sun, Upload, X, Loader2,
      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Lugares turísticos</h1>
              <p className="text-xs text-gray-400">Georeferencias y direcciones estructuradas</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <Link
        ...
        <section className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-4 sm:p-6 space-y-3">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                {cargando ? (
                  <p className="text-teal-600 dark:text-teal-400 font-medium">Procesando…</p>
                ) : isDragActive ? (
                  <p className="text-teal-600 dark:text-teal-400 font-medium">Suelta el archivo aquí</p>
                ) : (
                  <>
          ...
          <>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
                ...
                {(
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 sm:px-5 py-3 sm:py-4 text-xs sm:text-sm font-medium transition-colors
                      ${tab === id
                        ? 'text-teal-600 border-b-2 border-teal-600 bg-teal-50/50 dark:bg-teal-950/30'
              ...
              <div className="p-3 sm:p-6">
                ...
                {tab === 'log' && (
                  <LogLugares logs={resultado.logs} />
                )}
    ...
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
      <div className="max-h-[500px] overflow-y-auto divide-y divide-gray-100 dark:divide-gray-800">
        {logs.map((linea, i) => {
          ...
          const esError = linea.includes('sin georef') || linea.includes('ERROR')
          return (
            <div key={i} className="px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-800/50 flex items-start gap-3">
              ...
              >
                {esDuplicado ? 'Duplicado' : esError ? 'Sin georef' : 'OK'}
              </span>
